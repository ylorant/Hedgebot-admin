...
class SetupCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): bool
    {
        ...
        $filesystem->copy($envFilePath, $envLocalFilePath);

        $settings['DATABASE_URL'] = $dbLocation;
        $settings['APP_SECRET'] = sha1(random_bytes(32));
        $settings['HEDGEBOT_API_URI'] = 'http://' . $botSettings['uri'];
        $settings['HEDGEBOT_API_TOKEN'] = $botSettings['token'];
        ...
        file_put_contents($this->apiConfigPath, $defaultBaseConfigYaml);
    ...
    protected function askForDBLocation(InputInterface $input, OutputInterface $output)
    {
        ...
        // Creating questions
        $dbLocQuestion = new Question("Database file location (var/data.db): ", "data.db");
